...
//
// # theme-generators.mjs — pure per-agent CSS generators (no I/O).
//
// Extracted from generate-theme-css.mjs so the main process can import the
// 6 per-agent CSS template functions (traeworkCss / qoderworkCss / workbuddyCss /
// doubaoCss / codexCss / zcodeCss) without triggering the generation main loop.
// All functions are pure: colors in, CSS string out. The build/main-loop driver
// lives in generate-theme-css.mjs.

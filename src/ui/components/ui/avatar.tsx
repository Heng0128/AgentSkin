...
function AvatarBadge({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn(
        'absolute right-0 bottom-0 z-[var(--z-content)] inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground ring-2 ring-background select-none',

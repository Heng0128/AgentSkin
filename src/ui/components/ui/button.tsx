...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-sm border border-border-strong bg-card2 text-[10px] font-normal whitespace-nowrap transition-[background-color,border-color,color] outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 hover:border-primary hover:text-primary [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: "h-6 gap-1 rounded-sm px-1.5 text-[10px] in-data-[slot=button-group]:rounded-sm has-data-[icon-inline-end]:pr-1 has-data-[icon-inline-start]:pl-1 [&_svg:not([class*='size-'])]:size-3",
        lg: 'h-9 gap-1.5 px-2.5 has-data-[icon-inline-end]:pr-2 has-data-[icon-inline-start]:pl-2',
        icon: 'size-[30px] rounded-sm',
        'icon-xs':
          "size-6 rounded-sm in-data-[slot=button-group]:rounded-sm [&_svg:not([class*='size-'])]:size-3",
        'icon-sm': 'size-[26px] rounded-sm in-data-[slot=button-group]:rounded-sm',

    ...
    <div className="ws-dialog-overlay" aria-hidden="true">
      ...
      >
        <div className="px-[var(--space-4)] h-12 flex items-center justify-between border-b border-[var(--border-subtle)]">
          <span className="font-mono text-[length:12px] font-semibold text-[var(--fg-0)]">
            Workspaces
          </span>
          <button
            type="button"
        ...
        <div className="max-h-[360px] overflow-y-auto p-[var(--space-2)]">
          {WORKSPACE_PRESETS.map((preset) => (
            ...
            >
              <div className="size-8 rounded-[var(--r-xs)] border border-[var(--border-subtle)] bg-[var(--bg-1)] flex items-center justify-center font-mono text-[length:9px] text-[var(--fg-2)]">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="font-mono text-[length:10px] text-[var(--fg-3)] mt-[2px]">
                  {preset.viewMode}

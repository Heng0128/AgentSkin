  ...
  return (
    <div className="flex h-full flex-col rounded-[2px] border border-[var(--border-subtle)] bg-[var(--bg-1)] p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          className="ml-auto h-6 max-w-[240px] rounded-[2px] border border-[var(--border-subtle)] bg-[var(--bg-2)] px-2 font-mono text-[10px] text-[var(--fg-1)]"
          value={rawSheetIndex ?? ''}
      ...
      <div className="mt-4 flex min-h-0 flex-1 flex-col">
        {!hasAgent ? (
          <div className="flex flex-1 items-center justify-center rounded-[2px] border border-dashed border-[var(--border-subtle)] bg-[var(--bg-2)] p-8">
          ...
          <textarea
            ref={textareaRef}
            className="min-h-[200px] flex-1 resize-none rounded-[2px] border border-[var(--border-subtle)] bg-[var(--bg-2)] p-4 font-mono text-[11px] leading-relaxed text-[var(--fg-1)] outline-none focus:border-[var(--fg-3)]"
            value={rawCss}
      ...
      <div className="mt-4 flex items-center gap-2">
        <button
          ...
          className="h-7 rounded-[2px] bg-[var(--fg-0)] px-4 font-mono text-[10px] text-[var(--bg-1)] disabled:opacity-40"
        >
          {t.studioRawApply}
        </button>
        <button
          ...
          onClick={handleReset}
          disabled={!rawDirty || rawLoading || !hasSheets}
          className="h-7 rounded-[2px] border border-[var(--border-subtle)] bg-[var(--bg-2)] px-4 font-mono text-[10px] text-[var(--fg-1)] disabled:opacity-40"
        >
          {t.studioRawReset}
        </button>

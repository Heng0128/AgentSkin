...
export function localeFromSystem(_value: string | undefined): AppLocale {
  // 应用当前仅提供中文界面
...
export const uiMessages = {
  'zh-CN': {
    ...
    restartReasonNotRunning: '该应用未运行，请手动启动应用后重试',
    ...
    weStats: (video: number, image: number) => `${video} 动态 · ${image} 静态`,
  ...
  en: {
    ...
    weStats: (video: number, image: number) => `${video} dynamic · ${image} static`,

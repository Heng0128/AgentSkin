# Extract Summary — doubao

- **family**: chromium-webview
- **extractedAt**: 2026-08-18T13:55:02.972Z
- **port**: (auto-discovered)

## Frame

- **url**: `chrome://doubao-chat/chat/38438115344509442`
...
| 指标 | 值 |
|------|----|
| totalNodes | {"default":956,"dark":956,"light":956} |
| corsBlockedSheets | 0 |
| failedSchemes | _无_ |
| truncated | {"default":false,"dark":null,"light":null} |
| multiFrame / iframes | false / 0 |
| apiStillNative | true |
...
| 指标 | 值 |
|------|----|
| rootVars | {"default":1199,"dark":1199,"light":1199} |
| domNodes | {"default":956,"dark":956,"light":956} |
| styleVars | {"dark":2297,"light":1199,"neutral":2767} |
| stylesheets / corsErr | 92 / 0 |

## rootVariables 命名空间（每 scheme）
...
## rootVariables 来源形态（__host）

_（无 `__host` 标注，走原生 `:root` 快路径）_

## 语义锚点（stable id / class，非 hash）

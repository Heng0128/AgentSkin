// Extract native values for traework bare-prefix blind spots (--bg-bg-* /
// --text-text-* / --icon-icon-* families not covered by our engine/theme).
const PORT = process.argv[2] || '58510';
const T = [
  '--bg-bg-base-tertiary', '--bg-bg-menu', '--bg-bg-tooltip',
  '--bg-bg-overlay-l3', '--bg-bg-overlay-l4',
  '--bg-bg-brand', '--bg-bg-brand-hover', '--bg-bg-brand-active', '--bg-bg-brand-disabled',
  '--bg-bg-invert', '--bg-bg-invert-hover', '--bg-bg-invert-active', '--bg-bg-invert-disabled',
  '--text-text-default', '--text-text-secondary', '--text-text-tertiary',
  '--text-text-default-hover', '--text-text-default-active', '--text-text-brand',
  '--icon-icon-default', '--icon-icon-secondary', '--icon-icon-tertiary',
  '--icon-icon-default-hover', '--icon-icon-onaccent', '--icon-icon-disabled',
];
class CDP {
...
async function run() {
  ...
  const js = `(() => {
    ...
    const el = document.querySelector('html[data-theme]');
